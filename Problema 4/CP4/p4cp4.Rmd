...
- Esse resultado se assemelha com o que foi observado na análise para essa pergunta quando respondida utilizando os intervalos de confiança. Pelo valor do p-valor ainda ser próximo do nosso grau de confiança (0.05), podemos inferir uma pequena relação entre as estatísticas, assim como foi visto na análise anterior.  
