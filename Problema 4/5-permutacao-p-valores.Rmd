...
```{r}
ratings_raw <- read_csv("https://raw.githubusercontent.com/nazareno/ciencia-de-dados-1/master/4-Inferencia/dados/ml-latest-small/ratings.csv", col_types = "ccdi")
movies <- read_csv("https://raw.githubusercontent.com/nazareno/ciencia-de-dados-1/master/4-Inferencia/dados/ml-latest-small/movies.csv", col_types = "ccc")
